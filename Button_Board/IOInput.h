...
// Cài thời gian lấy mẫu là 10ms, số lần lấy mẫu mức cáo là 15, số lần lấy mẫu mức thấp là 5
...
//	Hàm: _IoB.GetTime(HIGH/LOW) sẽ trả về giá trị thời gian đến thời điểm hiện tại tính từ lúc xác nhận thay đổi input .
